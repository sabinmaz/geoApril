            ...
            <div class="col-md-4">
                <ucard header="Collines">
                    <template slot="content">
                            ...
                            <div class="col-md-12">
                                <utable id="province-table"
                                    ...
                                    <template slot="name" scope="item">
                                        <a v-bind:href="'/#/'+$route.params.country+'/'+$route.params.province+'/'+$route.params.commune+'/'+$route.params.zone+'/' +item.item.name" >{{item.item.name}}</a>
                                    </template>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <upagination size="md"  :total-rows="this.collines.length"
                                             :per-page="perPage"
    ...
    export default{
        ...
        data()
        {
            return {
                ...
                markers: [],
                fields: {
                    name: {label: 'Colline', sortable: true},
        ...
        created() {
            ...
            axios.get('/api/'+this.$route.params.country)
                .then(function (response)
                {
                    ...
                    axios.get('/api/'+self.country.iso2+'/'+self.$route.params.province+'/'+self.$route.params.commune+'/'+self.$route.params.zone+'/collines')
                        .then(function(response)
                        {
                            console.log(self.country);
                            //console.log(_.toArray(response.data));
                            self.collines=_.toArray(response.data);
                            //console.log(_.toArray(response.data));
...
//                    axios.get('/api/sdf/'+self.$route.params.zone)
//                        .then(function(response)
//                        {
//                            console.log(self.country);
//                            //console.log(_.toArray(response.data));
...
//                        console.log(error);
//                    });
                    axios.get('https://maps.googleapis.com/maps/api/geocode/json?address='+self.$route.params.zone+',+'+self.$route.params.commune+',+'+self.$route.params.province+',+'+self.country.country_name+'&key=AIzaSyBzlLYISGjL_ovJwAehh6ydhB56fCCpPQw')
                        .then(function (response)
                        {
