            ...
            <div class="col-md-4">
                <ucard header="Zones">
                    <template slot="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <upagination size="md"  :total-rows="this.zones.length"
                                             :per-page="perPage"
        ...
        created() {
            ...
            axios.get('/api/'+this.$route.params.country)
                .then(function (response)
                {
                    ...
                    axios.get('/api/'+self.country.iso2+'/'+self.$route.params.province+'/'+self.$route.params.commune+'/zones')
                        .then(function(response)
                        {
                            console.log(self.country);

                            self.zones=_.toArray(response.data);
...
//                    axios.get('/api/sdf/'+self.$route.params.commune)
//                        .then(function(response)
//                        {
//                            console.log(self.country);
//                            //console.log(_.toArray(response.data));
