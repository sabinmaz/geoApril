                            ...
                            <div class="col-md-12">
                                <utable id="province-table"
                                    ...
                                    <template slot="name" scope="item">
                                        <a v-bind:href="'/#/'+$route.params.country+'/'+$route.params.province+'/'+$route.params.commune+'/' +item.item.name" >{{item.item.name}}</a>
                                    </template>
    ...
    export default{
        ...
        data()
        {
            return {
                ...
                markers: [],
                fields: {
                    name: {label: 'Locality', sortable: true},
...
//                    axios.get('/api/sdf/'+self.$route.params.colline)
//                        .then(function(response)
//                        {
//                            console.log(self.country);
//                            //console.log(_.toArray(response.data));
...
//                        console.log(error);
//                    });
                    axios.get('https://maps.googleapis.com/maps/api/geocode/json?address='+self.$route.params.commune+',+'+self.$route.params.province+',+'+self.country.country_name+'&key=AIzaSyBzlLYISGjL_ovJwAehh6ydhB56fCCpPQw')
                        .then(function (response)
                        {
